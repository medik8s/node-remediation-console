...
import { split, selectorFromString } from "../module/selector";
import * as k8sSelectorRequirement from "../../module/selector-requirement";
import { selectorFromString } from "../module/selector";
...
export class SelectorInput extends React.Component {
  ...
  static arrayObjectsToArrayStrings(obj) {
    return _.map(
      obj,
      (v) => `${v.key} ${v.operator.toLowerCase()} (${v.values.join(",")})`
    );
  }
